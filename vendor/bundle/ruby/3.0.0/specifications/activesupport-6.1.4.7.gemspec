# -*- encoding: utf-8 -*-
# stub: activesupport 6.1.4.7 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rails/rails/issues", "changelog_uri" => "https://github.com/rails/rails/blob/v6.1.4.7/activesupport/CHANGELOG.md", "documentation_uri" => "https://api.rubyonrails.org/v6.1.4.7/", "mailing_list_uri" => "https://discuss.rubyonrails.org/c/rubyonrails-talk", "source_code_uri" => "https://github.com/rails/rails/tree/v6.1.4.7/activesupport" } if s.respond_to? :metadata=
